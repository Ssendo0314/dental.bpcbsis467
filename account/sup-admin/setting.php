                                    ...
                                    <div class="tab-pane" id="account">
                                        ...
                                        <form action="./function/update.php" method="GET">
                                            <div class="form-group">
                                                ...
                                                <p class="text-muted font-size-sm">This action is not available.</p>
                                            </div>
                                        ...
                                        <form>
                                            <div class="form-group mb-0">
                                                ...
                                                <ul class="list-group list-group-sm">
                                                    ...
                                                    $activity_query = "SELECT * FROM activity_logs WHERE user_id = {$row['user_id']} AND action = 'Owner Login' AND DATE(timestamp) = CURDATE() ORDER BY timestamp DESC";
