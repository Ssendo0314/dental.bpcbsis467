...
<head>
    ...
    <title>Contact dentist - dentist</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Detist Account</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./contact_dentist.php">Dashboard</a></li>
                        <li class="breadcrumb-item">Account</li>
                        <li class="breadcrumb-item">Staff Account</li>
                        <li class="breadcrumb-item active"><a href="./contact_dentist.php">Detist Account</a></li>
                    </ol>
                    <!--Message-->
                    ...
                    <div id="pagesCollapsehow" class="collapse alert alert-info">
                        ...
                        the button.
                        <br>
                        3.You can also sort if you want to see <a class="link" href="./contact_dentist.php"><strong>dentist
