...
<head>
    ...
    <title>Contact Admin - Admin</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a href="./contact_admin=deactivate.php">Admin
                                Account</a></li>
                    </ol>
                    <!--Message-->
                    <?php if (isset($_SESSION['success'])) { ?>
                        <div class="alert alert-success">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"
                                onclick="window.location.href ='contact_admin.php'"><span aria-hidden="true"><i
                    ...
                    <div id="pagesCollapsehow" class="collapse alert alert-info">
                        ...
                        the button.
                        <br>
                        3.You can also sort if you want to see <a class="link" href="./contact_admin.php"><strong>Admin
                                Account</strong></a>, <a class="link"
                            href="./contact_admin=active.php"><strong>Active</strong></a> and <a class="link"
                            href="./contact_admin=deactivate.php"><strong>Deactivate</strong></a>
                        <br>
                        ...
                        <br>
                        5. You can now <a class="link" href="./function/download/all_contact_admin.php"><i
                                class='bx bxs-download'></i> Download All</a> the Data of <a class="link"
                            href="./contact_admin.php"><strong>Admin Account</strong></a> using the button.
                        <br>
                        6.You can now <a class="Link" href="./function/print/all_contact_admin.php"><i
                                class='bx bxs-printer'></i> Print All</a> the data of <a class="link"
                            href="./contact_admin.php"><strong>Admin Account</strong></a> using the button.

                        <br><br>
                        <p>To learn more, <a href="../../help.php#contact_admin" target="_blank">Help Center for Admin
                                Account</a></p>
                    </div>
                    <div class="card mb-4">
                        <!--Secondary Nav-->
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            ...
                            <a class="btn btn-info text-white" data-bs-toggle="collapse"
                                ...
                                How
                                to use</a>
                            <a class="btn btn-secondary text-white" href="./contact_admin.php">All Contacts</a>
                            <a class="btn btn-success text-white" href="./contact_admin=active.php">Active</a>
                            <a class="btn btn-danger active text-white" href="./contact_admin=deactivate.php">Deactivate</a>
                            <!--add-->
                            ...
                            <table class="table table-bordered table-hover dt-responsive" id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    while ($user_row = mysqli_fetch_array($user_query)) {
                                        ...
                                        if ($user_row['role'] == "admin" && $user_row['status'] == "not active") { ?>
                                            <tr class="del<?php echo $id ?>">
                                                ...
                                                <td>
                                                    <?php if (!empty($user_row['location_id'])) {
                                                    ...
                                                    <?php } else if ($user_row['status'] == "temporary") { ?>
                                                                <form action="./function/update.php" method="GET">
                                                                    ...
                                                                    <button type="submit" class="btn bg-primary text-white"
                                                                        name="update_active_staff"
                                                                        onclick="return confirm('Are you sure you want to activate the account?')">Tempory</button>
                                                        <?php } ?>
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <a class="btn btn-primary text-white" href="./function/print/all_contact_admin.php"><i
                                class='bx bxs-printer'></i> Print All</a>
                        <a class="btn btn-dark text-white" href="./function/download/all_contact_admin.php"><i
