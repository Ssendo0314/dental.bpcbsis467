                ...
                <div class="container-fluid px-4">
                    ...
                    <div id="pagesCollapsehow" class="collapse alert alert-info">
                        ...
                        5.You can now <a class="Link" href="./function/print/all_contact.php"><i
                            ...
                            href="./contact_client.php"><strong>Client Account</strong></a> using the button.
                        <br><br>
                        <p>To learn more, <a href="../../help.php#contact_client" target="_blank">Help Center for Client
                                Account</a></p>
                    </div>
                    <div class="card mb-4">
                        <!--Secondary Nav-->
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            ...
                            <a class="btn btn-secondary active text-white" href="./contact_client.php">All Contacts</a>
                            <a class="btn btn-success text-white" href="./contact_client=active.php">Active</a>
                            <a class="btn btn-danger text-white" href="./contact_client=deactivate.php">Deactivate</a>
                        </div>
                    </div>
                    <div class="card mb-4">
