                                    ...
                                    <div class="card-body">
                                        <div>
                                            <a class="btn btn-secondary"
                                                href="./apk_history.php?location_id=<?php echo $location_row['location_id']; ?>&week=<?php echo $week - 1; ?>">Previous</a>
                                            <!-- Navigate to previous week -->

                                            <a class="btn btn-secondary"
                                                href="./apk_history.php?location_id=<?php echo $location_row['location_id']; ?>&week=<?php echo $week + 1; ?>">Next</a>
