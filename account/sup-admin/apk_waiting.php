            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Waiting Appointment</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item">My Pages</li>
                            <li class="breadcrumb-item">My Reports</li>
                            <li class="breadcrumb-item active">Waiting Appointment</li>
                        </ol>
                        <!--Message-->
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                ...
                                <a class="btn btn-dark text-white"
                                    href="./apk_history.php?location_id=<?php echo $location_row['location_id']; ?>">
                                    Apointment History</a>
                            </div>
                        </div>
                        <!--Table-->
                        <div class="card mb-4">
