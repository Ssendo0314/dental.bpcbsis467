            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a href="./contact_admin.php">Admin Account</a></li>
                    </ol>
                    <!--Message-->
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            ...
                            <a class="btn btn-success active text-white" href="./contact_admin=active.php">Active</a>
                            <a class="btn btn-danger text-white" href="./contact_admin=deactivate.php">Deactivate</a>
                            <!--add-->
                            ...
                            <table class="table table-bordered table-hover dt-responsive" id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    while ($user_row = mysqli_fetch_array($user_query)) {
                                        ...
                                        if ($user_row['role'] == "admin" && $user_row['status'] == "active") { ?>
