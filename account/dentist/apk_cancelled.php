        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Cancelled Apointment</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item">My Pages</li>
                        <li class="breadcrumb-item">My Reports</li>
                        <li class="breadcrumb-item active">Cancelled Apointment</li>
                    </ol>
                    <!--Card-->
                            ...
                            <table class="table table-bordered table-hover dt-responsive" id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    while ($schedule_row = mysqli_fetch_array($schedule_query)) {
                                        ...
                                        if ($schedule_row['user_id'] == $id && $schedule_row['status'] == 'Cancelled') {
                                            ?>
                                            <tr>
                                                <td>
                                                            ...
                                                            <li style="list-style-type: none;">
                                                                <form action="./function/update.php" method="GET">
                                                                    ...
                                                                    <button type="submit" class="btn btn-success"
                                                                        name="schedule_Done"
                                                                        onclick="return confirm('are you sure the schedule is Done?')">Appointment Done</button>
                                                                </form>
                                                                <br>
                                                                <form action="./function/update.php" method="GET">
                                                                    <input type="hidden" name="user_id"
