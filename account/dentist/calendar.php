...
$schedules = $conn->query("SELECT * FROM `schedule` WHERE user_id = {$row['user_id']}");
$sched_res = [];
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <ul class="list-group">
                                    ...
                                    $action_count_sql = "SELECT status, COUNT(*) AS log_count FROM schedule WHERE user_id = {$row['user_id']} GROUP BY status";
