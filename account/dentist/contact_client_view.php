...
<head>
    ...
    <link href="../../css/porfolio_profile.css" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    <!-- BoxIcons -->
    <link rel='stylesheet' href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css'>
    <title>Contact Client Account - Dentist</title>
    <!-- Bootstrap CSS -->
                                                        ...
                                                        <?php if ($member_row['status'] == "active") { ?>
                                                            <form action="./function/update.php" method="GET">
                                                                ...
                                                                <button type="submit" class="btn btn-outline-success"
                                                                    ...
                                                                    onclick="return confirm('Are you sure you want to deactivate the account?')"
                                                        ...
                                                        <?php } else if ($member_row['status'] == "deactivate") { ?>
                                                                <form action="./function/update.php" method="GET">
                                                                    ...
                                                                    <button type="submit" class="btn btn-outline-danger"
                                                                        name="update_active"
                                                                        onclick="return confirm('Are you sure you want to activate the account?')"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $member_row['firstname'] . ' ' . $member_row['lastname'] . ' ' . $member_row['suffixname']; ?>"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div>
                                                        <div class="row">
                                                            ...
                                                            if (mysqli_num_rows($image_result) > 0) {
                                                                ...
                                                                echo '<div class="alert alert-primary">No images found!</div>';
                                                            }
                                                            ?>
                                                        </div> <!-- / .row -->
                                                    </div>
