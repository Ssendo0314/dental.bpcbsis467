                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <?php if ($user_row['status'] == "active") { ?>
                                                            <form action="./function/update.php" method="GET">
                                                                ...
                                                                <input type="hidden" name="user_id_account"
                                                        ...
                                                        <?php } else if ($user_row['status'] == "deactivate") { ?>
                                                                <form action="./function/update.php" method="GET">
                                                                    <input type="hidden" name="user_id"
                                                                        value="<?php echo $_SESSION['dentist_id']; ?>">
                                                                    <input type="hidden" name="user_id_account"
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li
                                                        ...
                                                        <?php
                                                        $duty_query = mysqli_query($conn, "SELECT * FROM duty WHERE user_id = '$id'") or die(mysqli_error($conn));
                                                        while ($duty_row = mysqli_fetch_array($duty_query)) {
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $user_row['firstname'] . ' ' . $user_row['middlename']. ' ' . $user_row['lastname']; ?>"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <a
                                                                href="./update_profile.php?user_id=<?php echo $user_row['user_id']; ?>"><button
                                                                    type="button" class="btn btn-primary px-4"><i
                                                                        class='bx bx-add-to-queue'></i>
                                                                    Update Profile </button></a>
                                                            <button type="button" class="btn btn-secondary px-4"><i
