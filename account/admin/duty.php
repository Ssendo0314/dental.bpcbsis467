    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                //Office show 
                $user_id = $row['user_id'];
                $duty_main_query = "SELECT * FROM duty WHERE user_id = '$user_id'";
                $duty_main_result = mysqli_query($conn, $duty_main_query);
                while ($duty_main_row = mysqli_fetch_array($duty_main_result)) {
                    $duty_id = $duty_main_row['duty_id'];
                    $location_id = $duty_main_row['location_id'];

                    $location_query = mysqli_query($conn, "SELECT * FROM `location` WHERE location_id = '$location_id'");
                    $main_row = mysqli_fetch_array($location_query);
                    ?>
                    <br>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active"><a href="./duty.php?user_id=<?php echo $row['user_id']; ?>">List of Duty</a></li>
                        </ol>
                        <?php if (isset($duty_main_row['user_id']) && $duty_main_row['user_id']) { ?>
                            <div class="row">
                                <div class="col-xl-8">
                                    <div class="card">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <ul class="nav nav-tabs nav-tabs-custom border-bottom-0 mt-3 nav-justfied"
                                                            ...
                                                            <li role="presentation">
                                                                <!--add-->
                                                                <a href="./function/add_duty.php" class="btn  btn-primary text-white" onclick="openForm()"><i
                                            ...
                                            <div id="contentTeam">
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-bordered table-hover dt-responsive"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $duty_query = "SELECT * FROM `duty` WHERE `location_id` = '$location_id'";
                                                ...
                                                <div>
                                                    ...
                                                    for ($hour = $office_hours_start; $hour <= $office_hours_end; $hour++) {
                                                        ...
                                                        for ($day = 0; $day < 7; $day++) {
                                                            ...
                                                            $sql = "SELECT * FROM duty WHERE (duty_day = '$current_day' OR duty_day LIKE '%$current_day%') AND duty_start_time <= '$hour:00:00' AND duty_end_time > '$hour:00:00' AND location_id = '$location_id'";
                                        ...
                                        <div class="card-body">
                                            <div class="pb-2">
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    $action_count_sql = "SELECT status, COUNT(*) AS log_count FROM schedule WHERE location_id = '$location_id' GROUP BY status";
                                                    ...
                                                    if ($action_count_result && $action_count_result->num_rows > 0) {
                                                        while ($row = $action_count_result->fetch_assoc()) {
                                                            $action_counts[$row['status']] = $row['log_count'];
                                                        }
                                                    }
                                                    ?>
                        ...
                        <?php } else { ?>
                            <div class="alert alert-warning">
                                <strong>I am Sorry,</strong> but still do not have access on this!
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>
