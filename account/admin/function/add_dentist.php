            ...
            <div class="modal-content">
                ...
                <form class="formContainer" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="location_id" value="<?php echo $row['location_id']; ?>" name="location_id" required>
                    ...
                    if (isset($_POST['user_add'])) {
                        ...
                        // Database insertion
                        $user_query = "INSERT INTO `users` (`username`, `firstname`, `middlename`, `lastname`, `age`, `gender`, `role`, `password`, `birthday`, `status`, `location_id`) 
                        VALUES ('$username', '$firstname', '$middlename', '$lastname','$age', '$gender', '$role', '$password', '$birthday', '$status', '$location')";
                        ...
                        if ($user_result) {
                            ...
                            $_SESSION['success'] = "User added successfully! <br> username: $username and password: $password";
                            echo "<script>window.location.href=document.referrer;</script>";
                        } else {
