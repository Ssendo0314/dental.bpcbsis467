                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapsePages01" aria-labelledby="headingTwo"
                        ...
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            ...
                            <a class="nav-link" href="./duty.php?user_id=<?php echo $row['user_id']; ?>">List of Duty</a><!-- Duty -->
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapsePages02" aria-labelledby="headingTwo"
                        ...
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            ...
                            <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                data-bs-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="./apk_history.php">Appointment History</a>
                                    <!-- ap_history -->
                                    <a class="nav-link" href="./apk_waiting.php">Pending History</a> <!-- ap_waiting -->
                                    <a class="nav-link" href="./apk_done.php">Done History</a> <!-- ap_done -->
                                    <a class="nav-link" href="./apk_cancelled.php">Cancelled History</a>
                                    <!-- ap_cancelled -->
                                </nav>
                            </div>
                        </nav>
