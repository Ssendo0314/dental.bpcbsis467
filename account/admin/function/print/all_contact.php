...
<body>
    <h2>ALL Contact of The Client</h2>
...
while ($row = mysqli_fetch_assoc($result)) {
    $html .= '<tr>
                ...
                <td>' . $row['email'] . '</td>
                <td>' . $row['job'] . '</td>
                <td>' . $row['guardianfirstname'] . ' ' . $row['guardianmiddlename'] . ' ' . $row['guardianlastname'] . '</td>
                <td>' . $row['guardian_contact_no'] . '</td>
                <td>' . $row['guardian_job'] . '</td>
              </tr>';
}
