    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-primary text-white mb-4">
            <div class="card-body">Appointment History
                <?php
                $history_query = "select * from schedule where `location_id` = '{$row['location_id']}'";
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-warning text-white mb-4">
            <div class="card-body">Pending Appointment
                <?php
                $history_query = "select * from schedule where status= 'Waiting' AND `location_id` = '{$row['location_id']}'";
                $history_query_run = mysqli_query($conn, $history_query);
                if ($history_total = mysqli_num_rows($history_query_run)) { ?>
                    <h4 class="mb-0">
                        <?php echo $history_total ?>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-success text-white mb-4">
            <div class="card-body">Complete Appointment
                <?php
                $history_query = "select * from schedule where status= 'Done' AND `location_id` = '{$row['location_id']}'";
                $history_query_run = mysqli_query($conn, $history_query);
                if ($history_total = mysqli_num_rows($history_query_run)) { ?>
                    <h4 class="mb-0">
                        <?php echo $history_total ?>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-danger text-white mb-4">
            <div class="card-body">Cancel Appointment
                <?php
                $history_query = "select * from schedule where status= 'Cancelled' AND `location_id` = '{$row['location_id']}'";
                $history_query_run = mysqli_query($conn, $history_query);
                if ($history_total = mysqli_num_rows($history_query_run)) { ?>
                    <h4 class="mb-0">
                        <?php echo $history_total ?>
