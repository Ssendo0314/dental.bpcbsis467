            ...
            <div class="row">
                <div class="col-sm-3"><!--left col-->
                    <div class="text-center">
                        <!--Upload Images-->
                        <form class="form" action="./function/update_image.php" method="post" enctype="multipart/form-data">
                            <?php
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <?php if (!empty($user_row['bio'])) { ?>
                                            <input type="text" class="form-control" name="bio" id="bio"
                                                placeholder="500 words only" value="<?php echo $user_row['bio']; ?>">
                                        <?php } else { ?>
                                            <input type="text" class="form-control" name="bio" id="bio"
                                    ...
                                    <form class="form" action="#" method="post" accept-charset="UTF-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <br>
                                                <button class="btn btn-success" type="submit"
                                                    name="password_change"><i class="glyphicon glyphicon-ok-sign"></i>
                                                    Submit</button>
                                            </div>
                                        </div>
                                    </form>
