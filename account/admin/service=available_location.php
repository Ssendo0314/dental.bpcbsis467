        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Available in Location</h1>
                                ...
                                <tbody>
                                    ...
                                    if ($check_result) {
                                        ...
                                        if ($count > 0) {
                                            ...
                                            $service_query = "SELECT * FROM `service` WHERE FIND_IN_SET('" . $row['location_id'] . "', `location_id`)";
                                                        ...
                                                        <?php } else { ?>
                                                            <form action="./function/add.php" method="POST">
                                                                ...
                                                                <button type="submit" name="update_service_location_yes"
                                                                    ...
                                                                    onclick="return confirm('are you sure you want to active?')">Not
                                                                    Available</button>
                                                            </form>
                                                        <?php } ?>
                                                    </td>
