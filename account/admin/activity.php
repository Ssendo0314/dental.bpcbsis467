                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <a class="link" href="./profile.php?user_id=<?php echo $row['user_id']; ?>">
                                            <!-- profile -->
                                            Profile
                                        </a>
                                    </div>
                                ...
                                <div class="container mt-5 mb-6">
                                    <div class="row">
                                        <div class="col-md-12 offset-md">
                                            ...
                                            switch ($filter) {
                                                case 'today':
                                                    $sql = "SELECT * FROM activity_logs WHERE user_id = $id AND DATE(timestamp) = CURDATE() ORDER BY timestamp DESC";
                                                    break;
                                                case 'yesterday':
                                                    $sql = "SELECT * FROM activity_logs WHERE user_id = $id AND DATE(timestamp) = DATE_SUB(CURDATE(), INTERVAL 1 DAY) ORDER BY timestamp DESC";
                                                    break;
                                                case 'last_week':
                                                    $sql = "SELECT * FROM activity_logs WHERE user_id = $user_id AND DATE(timestamp) BETWEEN DATE_SUB(CURDATE(), INTERVAL 1 WEEK) AND CURDATE() ORDER BY timestamp DESC";
                                                    break;
                                                default:
                                                    $sql = "SELECT * FROM activity_logs WHERE user_id = $id ORDER BY timestamp DESC";
                                            }
