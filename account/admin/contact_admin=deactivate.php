            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a href="./contact_admin=deactivate.php">Deactivate
                                Account</a></li>
                    </ol>
                    <!--Message-->
                            ...
                            <table class="table table-bordered table-hover dt-responsive" id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    while ($user_row = mysqli_fetch_array($user_query)) {
                                        ...
                                        if ($user_row['role'] == "admin" && $user_row['status'] == "deactivate") { ?>
                                            <tr class="del<?php echo $id ?>">
                                                ...
                                                <td>
                                                    <?php if ($user_row['role'] == "dentist") { ?>
                                                        ...
                                                        <?php } else if ($user_row['status'] == "temorary") { ?>
                                                                    <button type="submit" class="btn bg-primary text-white" disabled>Temorary
                                                                        Adden</button>
