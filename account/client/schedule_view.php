                                ...
                                <li class="checkout-item">
                                    ...
                                    <div class="feed-item-list">
                                        <div>
                                            ...
                                            <?php if ($schedule_row['status'] == "Done") { ?>
                                                <?php
                                                $review_query = mysqli_query($conn, "SELECT * FROM `testimony` WHERE `id` = $schedule_id LIMIT 1") or die(mysqli_error($conn));
                                                while ($review_row = mysqli_fetch_array($review_query)) {
                                                    if ($review_row['id'] == $schedule_id) { ?>
                                                        <br><br>
                                                        <div class="alert alert-primary" role="alert">
                                                            Already Done with Review
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="container">
                                                            <form method="post" enctype="multipart/form-data"
                                                                action="./function/add.php">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea type="text" id="testimony" class="form-control"
                                                                                name="testimony" placeholder="Testimony..."
                                                                                required></textarea>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <!-- Select Location -->
                                                                            <input type="hidden" class="form-control" id="location_id"
                                                                                name="location_id"
                                                                                value="<?php echo $schedule_row['location_id']; ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="star"><strong>Review Star</strong></label>
                                                                            <select class="form-control" id="testimony" name="star"
                                                                                placeholder="Select Star" required>
                                                                        ...
                                                                        <input type="hidden" class="form-control" id="media"
                                                                            name="media" value="System">
                                                                        ...
                                                                        <br>
                                                                        <div class="form-group">
                                                                            <button type="submit" name="testimony_add"
