                                        ...
                                        <?php if (isset($_SESSION['success'])) { ?>
                                            <div class="alert alert-success">
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"
                                                    onclick="window.location.href ='./profile.php?member_id=<?php echo $row['member_id']; ?>'"><span
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <a
                                                                href="./update_profile.php?member_id=<?php echo $member_row['member_id']; ?>"><button
