                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4">
                                ...
                                if ($schedule_row = mysqli_fetch_assoc($schedule_result)) {
                                    ...
                                    <p>You have existing Appointment, Do you want to Cancelled?</p>
                                    ...
                                    <form action="./function/update.php" method="GET">
                                        ...
                                        <button type="submit" class="btn btn-danger" name="schedule_Cancelled"
                                            onclick="return confirm('are you sure the schedule is Cancelled?')">Cancel</button>
                                    </form>
                                    <br>
                                    <a href="./function/print/schedule_info.php?id=<?php echo $schedule_row['id']; ?>"><button
                        ...
                        <di class="col-xl-8">
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item link-secondary"><a href="./dashboard.php">Dashboard</a></li>
                                <li class="breadcrumb-item active link-secondary"><a href="./calendar.php">Calendar</a>
                                </li>
                            </ol>
