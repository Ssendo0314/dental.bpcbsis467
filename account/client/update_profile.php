...
<head>
    ...
    <title>Update Information - Client</title>
...
<body class="sb-nav-fixed">
    ...
    while ($member_row = mysqli_fetch_array($result)) {
        ...
        <?php if (isset($_SESSION['success'])) { ?>
            <div class="alert alert-success">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"
                    onclick="window.location.href ='./update_profile.php?member_id=<?php echo $member_row['member_id']; ?>'"><span
        ...
        <?php if (isset($_SESSION['message'])) { ?>
            <div class="alert alert-danger">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"
                    onclick="window.location.href ='./update_profile.php?member_id=<?php echo $row['member_id']; ?>'"><span
                        aria-hidden="true"><i class='bx bx-x-circle'></i></span></button>
                ...
                <div class="col-sm-3"><!--left col-->
                    <div class="text-center">
                        ...
                        <form class="form" action="./function/update.php" method="post">
                            ...
                            <br>
                            <button class="btn btn-success" type="submit" name="image_upload"><i
                    ...
                    <div class="card mb-4">
                        ...
                        <ul class="list-group">
                            ...
                            $action_count_sql = "SELECT status, COUNT(*) AS log_count FROM schedule WHERE member_id = {$row['member_id']} GROUP BY status";
                            ...
                            <?php foreach ($action_counts as $action => $count): ?>
                                <?php if ($action !== 'Update Active' && $action !== 'Update Deactive'): ?>
                                    <li class="test-dark list-group-item d-flex justify-content-between align-items-center">
                                        <?php echo $action ?>
                            ...
                            <form action="./function/update.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="facebook" name="facebook"
                                        placeholder="Enter Facebook URL" value="<?php echo $member_row['facebook']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="website_name">Website Name:</label>
                                    <input type="text" class="form-control" id="website_name" name="website_name"
                                        placeholder="Enter Website Name" value="<?php echo $member_row['website_name']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="website">Website:</label>
                                    <input type="text" class="form-control" id="website" name="website"
                                        placeholder="Enter Website URL" value="<?php echo $member_row['website']; ?>">
                                </div>
                                <button type="submit" class="btn btn-success" name="update_social">Submit</button>
                            </form>
                        </div>
                    </div>
                </div><!--/col-3-->
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home">
                            ...
                            <form class="form" action="./function/update.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        ...
                                        <input type="text" class="form-control" name="firstname" id="firstname"
                                            value="<?php echo $member_row['firstname']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        ...
                                        <input type="text" class="form-control" name="middlename" id="middlename"
                                            value="<?php echo $member_row['middlename']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        ...
                                        <input type="text" class="form-control" name="lastname" id="lastname"
                                            value="<?php echo $member_row['lastname']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            value="<?php echo $member_row['email']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        ...
                                        maxlength="11" value="<?php echo $member_row['contact_no']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="age" id="age"
                                            value="<?php echo $member_row['age']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <?php if (!empty($member_row['bio'])) { ?>
                                            <textarea class="form-control" name="bio" id="bio" placeholder="500 characters only"
                                                value="<?php echo $member_row['bio']; ?>" maxlength="500"></textarea>
                                        <?php } else { ?>
                                            <textarea class="form-control" name="bio" id="bio" placeholder="500 characters only"
                            ...
                            <form class="form" action="./function/update.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <h3><strong>The Guardian Information</strong></h3>
                                    </div>
                                </div>
                                <?php if (!empty($member_row['guardianfirstname'])) { ?>
                                    <input type="hidden" value="<?php echo $member_row['member_id']; ?>">
                                    <input type="hidden" value="<?php echo $member_row['minor']; ?>">
                                    <div class="form-group">
                                        <div class="col-xs-4">
                                            <label class="control-label" for="guardianfirstname">
                                                <h4>First Name</h4>
                                            </label>
                                            <input type="text" class="form-control" name="guardianfirstname"
                                                id="guardianfirstname" value="<?php echo $member_row['guardianfirstname']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-4">
                                            <label class="control-label" for="guardianmiddlename">
                                                <h4>Middle Name</h4>
                                            </label>
                                            <input type="text" class="form-control" name="guardianmiddlename"
                                                id="guardianmiddlename"
                                                value="<?php echo $member_row['guardianmiddlename']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-4">
                                            <label class="control-label" for="guardianlastname">
                                                <h4>Last Name</h4>
                                            </label>
                                            <input type="text" class="form-control" name="guardianlastname"
                                                id="guardianlastname" value="<?php echo $member_row['guardianlastname']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <label class="control-label" for="guardian_contact_no">
                                                <h4>Contact Num</h4>
                                            </label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <label class="control-label" for="guardian_job">
                                                <h4>Job</h4>
                                            </label>
                                            <input type="text" class="form-control" name="guardian_job" id="guardian_job"
                                                value="<?php echo $member_row['guardian_job']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <br>
                                            <button class="btn btn-lg btn-success" type="submit" name="gru_inform"><i
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <div class="alert alert-info">
                                                <strong>Note This!</strong> not a minor anymore
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                            ...
                            <div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <?php if (isset($_SESSION['success_user'])) { ?>
                                                    <input type="text" class="form-control" name="currentPassword"
                                                        id="currentPassword" value="<?php echo $member_row['password']; ?>"
                                                        disabled>
                                ...
                                <a class="btn btn-lg"
                                    href="./profile.php?member_id=<?php echo $member_row['member_id']; ?>">Back</a>
                                <hr>
                            </div>
                        </div>
                    </div>
